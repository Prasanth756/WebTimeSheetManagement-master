...
namespace WebTimeSheetManagement.Concrete
{
    public class TimeSheetConcrete : ITimeSheet
    {
        ...
        public IQueryable<TimeSheetMasterView> ShowTimeSheet(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.FromDate == Search || m.ToDate == Search || m.CreatedOn == Search || m.TimeSheetStatus.Contains(Search));
            }
        ...
        public IQueryable<TimeSheetMasterView> ShowAllTimeSheet(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            if (!string.IsNullOrEmpty(Search))
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.SubmittedMonth.Contains(Search) || m.Username.Contains(Search) || m.FromDate.Contains(Search) || m.ToDate.Contains(Search) || m.TimeSheetStatus.Contains(Search) || m.CreatedOn.Contains(Search));
            }
        ...
        public IQueryable<TimeSheetMasterView> ShowAllApprovedTimeSheet(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            if (!string.IsNullOrEmpty(Search))
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.FromDate.Contains(Search) || m.Username.Contains(Search) || m.CreatedOn.Contains(Search)|| m.SubmittedMonth.Contains(Search)|| m.ToDate.Contains(Search) || m.TimeSheetStatus.Contains(Search));
            }
        ...
        public IQueryable<TimeSheetMasterView> ShowAllSubmittedTimeSheet(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            if (!string.IsNullOrEmpty(Search))
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.FromDate.Contains(Search) || m.Username.Contains(Search) || m.ToDate.Contains(Search)|| m.SubmittedMonth.Contains(Search)|| m.TimeSheetStatus.Contains(Search)|| m.CreatedOn.Contains(Search));
            }
