    ...
    public class ProjectController : Controller
    {
        ...
        public ActionResult EditProjectDetails(int? ProjectID)
        {
            ...
            try
            {
                ...
                var userDetailsResponse = _IProject.GetProjectDetailsByProjectID(ProjectID);
                return PartialView("_EditProjectDetails", userDetailsResponse);
            }
            catch (Exception)
            {
                throw;
        ...
        public ProjectMaster SaveEditDetails(ProjectMaster project)
        {
