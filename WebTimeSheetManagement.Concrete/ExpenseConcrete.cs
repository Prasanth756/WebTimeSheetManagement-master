...
namespace WebTimeSheetManagement.Concrete
{
    public class ExpenseConcrete : IExpense
    {
        ...
        public IQueryable<ExpenseModelView> ShowExpense(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.FromDate == Search || m.ToDate == Search || m.ExpenseStatus.Contains(Search) || m.PurposeorReason.Contains(Search) );
            }
        ...
        public IQueryable<ExpenseModelView> ShowAllExpense(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            if (!string.IsNullOrEmpty(Search))
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.ProjectName.Contains(Search) || m.PurposeorReason.Contains(Search) || m.ExpenseStatus.Contains(Search) || m.FromDate == Search || m.ToDate == Search);
            }
        ...
        public IQueryable<ExpenseModelView> ShowAllSubmittedExpense(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            if (!string.IsNullOrEmpty(Search))
            {
                IQueryabletimesheet = IQueryabletimesheet.Where(m => m.FromDate.Contains(Search) || m.ToDate.Contains(Search) || m.ProjectName.Contains(Search) || m.PurposeorReason.Contains(Search) || m.ExpenseStatus.Contains(Search));
            }
